...
" feel free to choose :set background=light
set background=dark
colors candy
...
" Vimwiki
"{{{
let g:vimwiki_list = [{'path': '$HOME/Google\ Drive/config/vimwiki',
	\ 'html_header': '$HOME/Google Drive/config/vimwiki_html/header.tpl'}]
"}}}
...
" omnicomplete - better navigating
...
" set highlight search toggle options
"{{{
let g:mapleader = ","
...
" Setting backups to be local and only to my vimtmp directory
...
"map <Leader>ws :ChooseWin<cr> " No idea why this results in a conflict...???
" }}}
